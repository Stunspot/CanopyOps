# CanopyOps: support and recovery

## Support route

1. Search existing reports in the [repository issue tracker](https://github.com/Stunspot/CanopyOps/issues).
2. If you have repository access, open a new issue in the [repository issue tracker](https://github.com/Stunspot/CanopyOps/issues) and attach the [evidence bundle](#evidence-bundle).
