# CanopyOps v0.1.5 release notes

Release date: 2026-07-20

CanopyOps v0.1.5 is the plugin-identity and archive-custody release. It preserves the v0.1.4 operating kernel while replacing the generic greenhouse mark with a category-native cultivation-canopy operations grid and making every supported distribution independently obtainable and auditable.

## Changed

- Introduced a product-specific, small-size-legible CanopyOps icon: four cultivated canopies joined by an operations grid and one coral decision point.
- Version-bound the plugin listing to the new icon rather than a mutable generic alias.
